  ...
  const fetchJadwal = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/jadwals/guru`,
        {
          method: "POST",
          headers: {
    ...
    try {
      ...
      const pdfContent = `
        <div style="padding: 20px; font-family: Arial, sans-serif;">
          <h1 style="text-align: center; font-size: 24px; margin-bottom: 10px;">Jadwal Guru</h1>
