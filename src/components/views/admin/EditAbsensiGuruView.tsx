...
const EditAbsenGuruView = ({ id }: any) => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/absensi_guru/update/${id}`,
        {
          method: "PATCH",
          headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const responseDataAbsensi = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/absensi_guru/${id}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
        ...
        const dataAbsensi = await responseDataAbsensi.json();
        setDataAbsen(dataAbsensi.data);
      } catch (error) {
        console.error("Fetch error:", error);
      } finally {
        setLoading(false);
        ...
        <form action="" onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <div className="space-y-1 w-full">
              ...
              <select
                id="kelas"
                defaultValue={dataAbsen?.kelasId || ""}
                {...register("kelasId", {
                  required: {
                    value: true,
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="space-y-1 w-full">
              ...
              <select
                ...
                defaultValue={dataAbsen?.mapelId}
                className="w-full p-2 border border-gray-300 focus:outline-blue-400 rounded-md"
              >
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="space-y-1 w-full">
              ...
              <select
                ...
                defaultValue={dataAbsen?.jam_mulai}
                className="w-full p-2 border border-gray-300 focus:outline-blue-400 rounded-md"
              >
            ...
            <div className="space-y-1 w-full">
              ...
              <select
                id="jam_selesai"
                defaultValue={dataAbsen?.jam_selesai}
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="space-y-1 w-full">
              ...
              <input
                ...
                className="w-full p-2 border border-gray-300 focus:outline-blue-400 rounded-md"
                value={dataAbsen?.tanggal.split("T")[0]}
              />
              {errors.tanggal && (
                <span className="text-red-500 text-sm">
...
export default EditAbsenGuruView;
