...
const ImportMapelView = () => {
    ...
    if (file) {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/mapels/import`,
          {
            method: "POST",
            headers: {
  ...
  return (
    <div className="w-full space-y-3 p-4">
      <h1 className="text-xl font-semibold">Import Mapel</h1>
      ...
      <div className="bg-white p-4 rounded-md">
        <div className="flex justify-end gap-3">
          ...
          <Link
            href={`${process.env.NEXT_PUBLIC_API_URL}/mapels/download/template`}
...
export default ImportMapelView;
